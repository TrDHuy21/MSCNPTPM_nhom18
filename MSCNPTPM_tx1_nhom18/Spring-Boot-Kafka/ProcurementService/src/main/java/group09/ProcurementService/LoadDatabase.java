...
public class LoadDatabase
{
    ...
    CommandLineRunner initDatabase(SupplierRepository supplierRepository, ContactRepository contactRepository) {
        ...
        return args -> {
            ...
            //testing
            log.info("Preloading " + supplier1.toString());
            log.info("Preloading " + supplier2.toString());
            log.info("Preloading " + supplier3.toString());
            log.info("Preloading " + supplier4.toString());
            log.info("Preloading " + supplier5.toString());
            log.info("Preloading " + supplier6.toString());
            log.info("Preloading " + contact1.toString());
            log.info("Preloading " + contact2.toString());
            log.info("Preloading " + contact4.toString());
            log.info("Preloading " + contact4.toString());
            log.info("Preloading " + contact5.toString());
            log.info("Preloading " + contact6.toString());

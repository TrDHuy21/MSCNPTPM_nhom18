...
namespace ProductSalesAnomalyDetection
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            <ProductSalesData>(path: _dataPath, hasHeader: true, separatorChar: ',');
        ...
        static void DetectSpike(MLContext mlContext, int docSize, IDataView productSales)
        {
            ...
            var iidSpikeEstimator = mlContext.Transforms.DetectIidSpike
                ...
                inputColumnName: nameof(ProductSalesData.numSales), confidence: 95, 
        ...
        static void DetectChangepoint(MLContext mlContext, int docSize, IDataView productSales)
        {
            ...
            var iidChangePointEstimator = mlContext.Transforms.DetectIidChangePoint(outputColumnName:
                ...
                confidence: 95d, changeHistoryLength: docSize / 4);
            ...
            foreach (var p in predictions)
            {
                ...
                if (p.Prediction[0] == 1){results += " <-- alert is on, predicted changepoint";}
                Console.WriteLine(results);
            }
            Console.WriteLine("");
        }
